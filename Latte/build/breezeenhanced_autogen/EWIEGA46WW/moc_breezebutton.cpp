...
struct qt_meta_stringdata_CLASSBreezeSCOPEButtonENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSBreezeSCOPEButtonENDCLASS = QtMocHelpers::stringData(
    "Breeze::Button",
    "reconfigure",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSBreezeSCOPEButtonENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Breeze::Button::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSBreezeSCOPEButtonENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSBreezeSCOPEButtonENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSBreezeSCOPEButtonENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Breeze::Button::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSBreezeSCOPEButtonENDCLASS.stringdata0))
